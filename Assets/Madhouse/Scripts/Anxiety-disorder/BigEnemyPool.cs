...
namespace Madhouse.AnxietyDisorder
{
    public class BigEnemyPool : MonoBehaviour
    {
        ...
        [SerializeField] private BigEnemy enemyPrefab;
        ...
        private BigPoolMono<BigEnemy> pool;

        private void Start()
        {
            this.pool = new BigPoolMono<BigEnemy>(this.enemyPrefab, this.poolCount, this.transform);
